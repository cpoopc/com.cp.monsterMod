...
import com.cp.monsterMod.ui.fragments.list.NowPlayingFragment;
import com.cp.monsterMod.ui.widgets.BottomActionBar;
    ...
    private void setPauseButtonImage() {
        try {
            if (MusicUtils.mService != null && MusicUtils.mService.isPlaying()) {
                mPlay.setImageResource(R.drawable.selector_pause);
            } else {
