...
import com.cp.monsterMod.app.widgets.AppWidget11;
import com.cp.monsterMod.app.widgets.AppWidget41;
import com.cp.monsterMod.app.widgets.AppWidget42;
import com.cp.monsterMod.cache.ImageInfo;
import com.cp.monsterMod.helpers.GetBitmapTask;
import com.cp.monsterMod.helpers.GetBitmapTask.OnBitmapReadyListener;
import com.cp.monsterMod.helpers.utils.ImageUtils;
import com.cp.monsterMod.helpers.utils.MusicUtils;
import com.cp.monsterMod.helpers.utils.VisualizerUtils;
import com.cp.monsterMod.preferences.SharedPreferencesCompat;

import static com.cp.monsterMod.Constants.APOLLO_PREFERENCES;
import static com.cp.monsterMod.Constants.DATA_SCHEME;
...
import static com.cp.monsterMod.Constants.VISUALIZATION_TYPE;
...
public class ApolloService extends Service implements GetBitmapTask.OnBitmapReadyListener {
    ...
    public static final String APOLLO_PACKAGE_NAME = "com.cp.monsterMod";

    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String PLAYSTATE_CHANGED = "com.cp.monsterMod.playstatechanged";

    public static final String META_CHANGED = "com.cp.monsterMod.metachanged";

    public static final String FAVORITE_CHANGED = "com.cp.monsterMod.favoritechanged";

    public static final String QUEUE_CHANGED = "com.cp.monsterMod.queuechanged";

    public static final String REPEATMODE_CHANGED = "com.cp.monsterMod.repeatmodechanged";

    public static final String SHUFFLEMODE_CHANGED = "com.cp.monsterMod.shufflemodechanged";

    public static final String PROGRESSBAR_CHANGED = "com.cp.monsterMod.progressbarchnaged";

    public static final String REFRESH_PROGRESSBAR = "com.cp.monsterMod.refreshprogessbar";

    public static final String CYCLEREPEAT_ACTION = "com.cp.monsterMod.musicservicecommand.cyclerepeat";

    public static final String TOGGLESHUFFLE_ACTION = "com.cp.monsterMod.musicservicecommand.toggleshuffle";

    public static final String SERVICECMD = "com.cp.monsterMod.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.cp.monsterMod.musicservicecommand.togglepause";

    public static final String PAUSE_ACTION = "com.cp.monsterMod.musicservicecommand.pause";

    public static final String PREVIOUS_ACTION = "com.cp.monsterMod.musicservicecommand.previous";

    public static final String NEXT_ACTION = "com.cp.monsterMod.musicservicecommand.next";
    ...
    private void updateNotification() {
        ...
        status.contentIntent = PendingIntent
                .getActivity(this, 0, new Intent("com.cp.monsterMod.PLAYBACK_VIEWER")
